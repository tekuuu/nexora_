...
export interface ConfidentialDAIInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DAI_ADDRESS"
      | "burnFrom"
...
export interface ConfidentialDAI extends BaseContract {
  connect(runner?: ContractRunner | null): ConfidentialDAI;
  waitForDeployment(): Promise<this>;

  interface: ConfidentialDAIInterface;
  ...
  DAI_ADDRESS: TypedContractMethod<[], [string], "view">;
