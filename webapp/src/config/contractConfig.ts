...
export const LATEST_CONTRACTS = {
  SEPOLIA: {
    ...
    POOL_ADDRESS: '0x6Aca601deF3779937600bE6d0605DB6C0b5d339C',
    
    // Confidential tokens (✨ decimals() override + no aggregation)
    CWETH_ADDRESS: '0xcA185E2f8eCC2c83Ea2B3A256e334b103293d705',   // 18 decimals ✅
    CUSDC_ADDRESS: '0x4CBBcaEbe5f295CEdB7B72F5c2e29593Bf034641',   // 6 decimals ✅
    CDAI_ADDRESS: '0x7a7b8537497e232aBA0563FDEF9B90E4Dcd27aB5',    // 18 decimals ✅
...
const ENV_CONTRACTS = {
  POOL_ADDRESS: '0x6Aca601deF3779937600bE6d0605DB6C0b5d339C',  // ✨ DEPLOYMENT #12 - DEBT CONVERSION BUG FIXED
